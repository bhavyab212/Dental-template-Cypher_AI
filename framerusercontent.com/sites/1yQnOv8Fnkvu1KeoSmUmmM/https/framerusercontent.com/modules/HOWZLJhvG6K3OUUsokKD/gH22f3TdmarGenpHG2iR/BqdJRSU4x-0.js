...
var e,
  ...
  l = (t, e) =>
    function () {
      try {
        return (
          e || (0, t[a(t)[0]])((e = { exports: {} }).exports, e), e.exports
        );
      } catch (t) {
        throw ((e = 0), t);
      }
...
var F = class {
  ...
  writeUint64(t) {
    M(t, E.Uint64, T.Uint64, "Uint64");
    let e = BigInt(t);
    this.writeBigUint64(e);
  }
  writeBigUint64(t) {
    M(t, E.BigUint64, T.BigUint64, "BigUint64");
    let e = g.BigUint64;
    this.ensureLength(e),
  ...
  writeInt64(t) {
    M(t, E.Int64, T.Int64, "Int64");
    let e = BigInt(t);
    this.writeBigInt64(e);
  }
  writeBigInt64(t) {
    M(t, E.BigInt64, T.BigInt64, "BigInt64");
    let e = g.BigInt64;
    this.ensureLength(e),
...
((t) => {
  (t.read = function (t) {
    ...
    (t.compare = function (t, e, r) {
      ...
      switch (t.type) {
        case P.Array:
          return I(e.type === P.Array), j(t, e, r);
        case P.Boolean:
        ...
        case P.RichText:
          return I(e.type === P.RichText), tv(t, e);
        case P.VectorSetItem:
...
var tU = class e {
    sortEntries() {
      this.entries.sort((t, e) => {
        for (let n = 0; n < this.fieldNames.length; n++) {
          let i = t.values[n],
            s = e.values[n],
            a = r.compare(i, s, this.options.collation);
          if (0 !== a) return a;
        }
    ...
    static deserialize(t) {
      ...
      for (let t = 0; t < u; t++) {
        ...
        let e = O.read(n);
        o.entries.push({ values: t, pointer: e });
      }
      return o;
    }
    serialize() {
...
var tN = class {
  async loadModel() {
    let [t] = await tT(this.options.url, [this.options.range]);
   ...
   */ getLeftMost(t, e, n) {
    ...
    for (; i < s; ) {
      let a = (i + s) >> 1,
        o = t[a],
        u = o.values[e];
      0 > r.compare(u, n, this.collation) ? (i = a + 1) : (s = a);
    }
    return i;
  }
  /**
   ...
   */ getRightMost(t, e, n) {
    ...
    for (; i < s; ) {
      let a = (i + s) >> 1,
        o = t[a],
        u = o.values[e];
      r.compare(u, n, this.collation) > 0 ? (s = a) : (i = a + 1);
    }
    return s - 1;
  }
  /**
  ...
  constructor(e) {
    ...
    for (let t of this.options.fieldNames) {
      ...
      I(e, "Missing definition for field", t),
        (r[t] = e),
        n.push({ type: "Identifier", name: t });
    }
    (this.schema = r),
      (this.fields = n),
          ...
          new d.default(
            async (t) => {
              let e = t.map((t) => {
                ...
                r = await tT(this.url, e);
              return r.map((e, r) => {
                let n = new v(e),
                  i = tA(n),
                  s = t[r];
                return I(s, "Missing pointer"), { pointer: s, data: i };
              });
            },
            { maxBatchSize: 250 }
          )
